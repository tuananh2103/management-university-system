...
public class MyFastFood {
	...
	public static void main(String regNumber) {
		...
		try {
			//tao object de tao file co the doc du lieu 
			...
			while(ordering) {
				...
				try {
					...
					case 1 : 
						...
						if (quantity > 0) {
							runningTotal += itemPrice(); // gia cua do vat qua class itemPrice()
							System.out.println();
							bw.write("You've ordered a burger\n" + "Quantity :"+quantity+"\n");
							System.out.println("\n1.Return\nPress any Interger except '1' ");
							while(true) {
								try {
									item_return = input.nextInt(); // tra hang hoac khong 
					...
					case 3 : 
						...
						if ( quantity > 0) {
							runningTotal += itemPrice();
							System.out.println();
							bw.write("You've ordered a Shawarma " + "Quantity: " +quantity +"\n");
							System.out.println("\n1.Return\nPress any Interger '1' ");
							while(true) {
								try {
									item_return = input.nextInt();
							...
							if( item_return ==1) {
								...
								bw.write("You've ordered a Shawarma" + "Quantity: " +quantity_return +"\n");
								if (quantity_return > 0) {
									if ((quantity - quantity_return ) > 0) {
										writer.write("A Shawarma          " + (quantity-quantity_return )+ ((quantity-quantity_return)*120) );
										writer.write("\n");
									}else if (quantity_return == quantity) {
										writer.write("A Shawarma          "+quantity +"    "+(quantity*250));
										writer.write("\n");
										break;
									}
					...
					case 5 : 
        				...
        				if (quantity > 0) {
        					runningTotal += itemPrice();
        					System.out.println();
        					bw.write("You've ordered a Sanwich\n" + "Quantity: "+quantity +"\n");
        					System.out.println("\n1.Return\nPress any Integer except '1' ");
        					while(true) {
        						try {
        							item_return = input.nextInt();
